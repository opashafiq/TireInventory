...
[Table("tbl_Layaway_Details")]
public partial class LayawayDetails
{
    ...
    public virtual LayawayMaster tbid_Invoice { get; set; } = null!;
    public virtual ItemMaster? tbid_Item{ get; set; } = null!;
}
